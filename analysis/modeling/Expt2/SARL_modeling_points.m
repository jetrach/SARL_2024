%% BASED ON CODE FROM V3 TASKS --> NEED TO ADAPT THIS AND FUNC_2ALPHA/FUNC_1ALPHA TO HAVE THREE OPTIONS IF YOU WANT TO USE THIS

clear all;close all;clc;

% Read in data
data = readtable('SARLrep_prolific_n133_final.csv'); % load data;
...
for si = 1:nsubs
    ...
    preRLidx = strcmp(subdata.rlType,'preRL'); % subset data of attention trials pre-RL trial
    ...
    cor = nan(1,nrl);% init some other stuff
    ...
    for k = 1:n_fitting_iter
        ...
        % last few inputs are actual subject data
...
save models/modelFit_1a modelFit_1a
save models/modelFit_2a modelFit_2a
